    ...
    .then(function (data) {
      ...
      for (var i = 0; i < 9; i++) {
        ...
        saveBtn
          .attr("data-name", [i])
          .attr("data-position", "top")
          .attr("data-tooltip", "Click to save recipe to Recipe box.");
    ...
    if (user != null) {
      ...
      database.ref("/users/" + uid).on("child_added", function (childSnapshot) {
        ...
        pencil
          ...
          .attr("data-position", "top")
          .attr("data-tooltip", "Click to add notes to recipe.")
          .attr("href", "#notes-modal");
        ...
        pencil.on("click", function (e) {
          ...
          var modalContent = $("<div>")
            .addClass("modal-content pencilRm")
            .attr("data-key", key);
          //Create modal close button
          var closeButton = $("<i>")
            .addClass("material-icons right modal-action modal-close")
            .text("close");
          //Append close button to modal.
          modalContent.append(closeButton);
          var notesHeader = $("<h4>").text(name);
          var notesInput = $("<div>")
            .addClass("input-field recipe-notes")
            .attr("data-key", key);
          ...
          saveNotesBtn
            .addClass("btn waves-effect waves-light modal-trigger noteSave")
            .attr("href", "#notes-modal")
            .attr("data-key", key)
            .attr("type", "submit");
          ...
          deleteNotesBtn
            .addClass("btn waves-effect waves-light modal-trigger notesSave ")
            .attr("href", "#notes-modal")
            .attr("data-key", key)
            .attr("type", "submit");
...
function logOut() {
  ...
  $(".bg").css(
    "background-image",
    'url("../public/assets/images/login-bg.png")'
  );
}
