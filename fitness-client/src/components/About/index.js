                ...
                <div className="tiles-item-inner">
                  <div className="features-tiles-item-header">
                    ...
                    <div className="linksref">
                      <a href="https://github.com/WillisK-0" target="_blank">
                        <Image
                        ...
                        <a href="https://www.linkedin.com/in/keith-willis-528251156/" target="_blank">
                        <Image
            ...
            <div className="devCont">
              <div className="tiles-item-inner">
                <div className="features-tiles-item-header">
                  ...
                  <div className="linksref">
                  <a href="https://github.com/JGarcia1998" target="_blank">
                        <Image
                              src={require("./icons/gh.svg")}
                      ...
                      <a href="https://www.linkedin.com/in/jared-garcia-3a51741a6/" target="_blank">
                      <Image
                              src={require("./icons/ln.svg")}
            ...
            <div className="devCont">
              <div className="tiles-item-inner">
                <div className="features-tiles-item-header">
                  ...
                  <div className="linksref">
                  <a href="https://github.com/NathanNOSudo" target="_blank">
                        <Image
                              src={require("./icons/gh.svg")}
                      ...
                      <a href="https://www.linkedin.com/in/nathanorris/" target="_blank">
                      <Image
                              src={require("./icons/ln.svg")}
            ...
            <div className="devCont">
              <div className="tiles-item-inner">
                <div className="features-tiles-item-header">
                  ...
                  <div className="linksref">
                  <a href="https://github.com/h-drew-ellis" target="_blank">
                        <Image
                              src={require("./icons/gh.svg")}
                      ...
                      <a href="https://www.linkedin.com/in/andrew-311is/" target="_blank">
                      <Image
                              src={require("./icons/ln.svg")}
